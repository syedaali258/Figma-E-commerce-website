        ...
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            ...
            <div className="text-center">
              <Image
                src="/ttentor_modular_sofa-removebg-preview.png"
                alt="Product 1"
                width={1000}
                height={1000}
            ...
            <div className="text-center">
              <Image
                src="/granite-dinning-table-removebg-preview.png"
                alt="Product 2"
                width={200}
                height={200}
                className="object-contain mx-auto"
            ...
            <div className="text-center">
              <Image
                src="/outdoor_bar_table-removebg-preview.png"
                alt="Product 3"
                width={200}
                height={200}
                className="object-contain mx-auto"
            ...
            <div className="text-center">
              <Image
                src="/plain_console-removebg-preview.png"
                alt="Product 4"
                width={200}
                height={200}
                className="object-contain mx-auto"
